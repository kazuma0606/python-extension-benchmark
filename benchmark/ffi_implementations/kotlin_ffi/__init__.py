"""
Kotlin FFI implementation for benchmark system.

This module provides Kotlin language functions accessible via FFI (ctypes).
"""

from .ffi_wrapper import KotlinFFI

__all__ = ['KotlinFFI', 'find_primes', 'matrix_multiply', 'sort_array', 'filter_array', 'parallel_compute']
...
def _get_instance():
    ...
    if _instance is None:
        _instance = KotlinFFI(skip_uv_check=True)
    return _instance
