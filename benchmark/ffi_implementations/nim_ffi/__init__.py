"""
Nim FFI implementation for benchmark system.

This module provides Nim language functions accessible via FFI (ctypes).
"""

from .ffi_wrapper import NimFFI

__all__ = ['NimFFI', 'find_primes', 'matrix_multiply', 'sort_array', 'filter_array', 'parallel_compute']
...
def _get_instance():
    ...
    if _instance is None:
        _instance = NimFFI(skip_uv_check=True)
    return _instance
