...
This module provides Numpy language functions accessible via FFI (ctypes).
"""

from .ffi_wrapper import NumPyFFI

__all__ = ['NumPyFFI', 'find_primes', 'matrix_multiply', 'sort_array', 'filter_array', 'parallel_compute']
...
def _get_instance():
    ...
    if _instance is None:
        _instance = NumPyFFI(skip_uv_check=True)
    return _instance
