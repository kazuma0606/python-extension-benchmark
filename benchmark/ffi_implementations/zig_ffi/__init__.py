"""
Zig FFI implementation for benchmark system.

This module provides Zig language functions accessible via FFI (ctypes).
"""

from .ffi_wrapper import ZigFFI

__all__ = ['ZigFFI', 'find_primes', 'matrix_multiply', 'sort_array', 'filter_array', 'parallel_compute']
...
def _get_instance():
    ...
    if _instance is None:
        _instance = ZigFFI(skip_uv_check=True)
    return _instance
